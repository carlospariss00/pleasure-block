...
function App() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-2 sm:p-4 bg-slate-950 text-slate-100 font-sans overflow-hidden select-none">
      <Header />
