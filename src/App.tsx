  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 bg-slate-950 text-slate-100 font-sans overflow-hidden select-none">
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full max-w-2xl relative">
        ...
        <div className="absolute top-[-100px] left-0 right-0 z-50 pointer-events-none flex flex-col items-center">
          <AnimatePresence>
            {showLevelUp && (
              ...
              >
                <div className="text-6xl font-black text-amber-400 drop-shadow-[0_0_15px_rgba(251,191,36,0.6)] uppercase italic tracking-tighter">
                  ¡Level Up!
                </div>
        ...
        <div className={`w-full max-w-md aspect-square bg-slate-900 rounded-3xl border-4 border-slate-800 shadow-2xl flex items-center justify-center overflow-hidden relative mb-12 transition-opacity ${isPaused ? 'opacity-40 pointer-events-none' : 'opacity-100'}`}>
          ...
          <AnimatePresence>
            {showFullClear && (
              ...
              >
                <div className="text-5xl font-black text-amber-400 drop-shadow-[0_0_20px_rgba(251,191,36,0.8)] italic uppercase tracking-tighter text-center">
                  ¡TABLERO LIMPIO!
                </div>
        ...
        <div className={`w-full max-w-md h-36 bg-slate-900/50 rounded-2xl border-2 border-slate-800 flex justify-around items-center px-4 gap-4 backdrop-blur-sm transition-opacity ${gameOver || isPaused ? 'opacity-20 pointer-events-none' : 'opacity-100'}`}>
          {pieces.map((piece, i) => (
